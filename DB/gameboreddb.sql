...
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`, `first_name`, `last_name`, `email`, `address_id`, `profile_image_url`, `bio_description`, `create_date`) VALUES (7, 'operationsmaug', 'operationsmaug', 1, 'user', 'Lord', 'Smaug', 'lordsmaug@gamebored.com', NULL, 'https://static.wikia.nocookie.net/lotr/images/9/98/SmaugDestroyingLakeTownCropped.jpg/revision/latest?cb=20160721034440', NULL, NULL);
